...
const AddressFormFull : React.FC<any> = ({
    setValueAddress,
    valueAddres
}) => {
            ...
            <Grid container>
                ...
                <Grid item xl={9} lg={9} xs={12}>
                    <TextField
                        ...
                        name="zipcode"
                        label="Zip Code"
                        onChange={(e) => setValueAddress({...valueAddres, zipcode : e.target.value })}
                        value={valueAddres.zipcode}
                        type="text"
                        id="zipcode"
                        size="small"
                    />
